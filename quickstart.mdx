...
- `llama-3-70b-instruct` (chat model)
- `Llama-3-8b-instruct` (chat model)
- `llama-3-70b` (completion model)
- `llama-3-8b` (completion model)

### Llama-2

- `llama-2-7b-chat` or `llama-7b-chat`
- `llama-2-7b-32k` or `llama-7b-32k`
- `llama-2-13b-chat` or `llama-13b-chat`
- `llama-2-70b-chat` or `llama-70b-chat`
