...
api_request_json = {
  ...
  "messages": [
    {"role": "user", "content": "Make a summary of my last e-mail, login: mail@mail.com and password: nnmy fvbx sucz gxdu"},
  ],
  "functions": [
    {
...
- Parameters: Where we define which parameters we want to extract from the function. Still within parameters, we define that it will be of type object and will have three properties, two of type string, login and password, and value of type integer
...
### Response
```
{'role': 'assistant', 'content': None, 'function_call': {'name': 'get_email_summary', 'arguments': {'value': 1, 'login': 'login', 'password': 'password'}}}
```
...
api_request_json = {
  "model": "llama-70b-chat",
  "messages": [
    {"role": "user", "content": "Send a invite to mail@mail.com, from: llama@mail.com and password: password, Schedule a meeting on 01/18/2024, starting at 18 and ending at 19. With the title Sales Preview, description Meeting with marketing time to evaluate the semester"},
  ],
  "functions": [
    {
        ...
        "required": ["receiver","sender","password","day","startAt", "endAt", "title", "description"]
        }
    }
  ],
}
...
```json
{'role': 'assistant', 'content': None, 'function_call': {'name': 'schedule_meeting', 'arguments': '{"receiver": "mail@mail.com", "sender": "llama@mail.com", "password": "password", "startAt": "2024-01-18 18:00:00", "endAt": "2024-01-18 19:00:00", "title": "Sales Preview", "description": "Meeting with marketing time to evaluate the semester"}'}}
```
